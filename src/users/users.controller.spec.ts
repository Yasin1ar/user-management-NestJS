...
describe('UsersController', () => {
  ...
  it('should create a user', async () => {
    const userData = { username: 'newuser', password: 'pass', role: 'user' as const };
    const createdUser = { ...userData, id: 1 }; // Fixed order to avoid overwrite warning
  ...
  it('should update a user', async () => {
    ...
    expect(await controller.update('1', updateData as User)).toEqual(updatedUser);
